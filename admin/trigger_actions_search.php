...
$rsData = CFTriggerActions::GetList($by, $order);
...
$lAdmin->AddHeaders(array(
	...
	array("id"=>"SORT",				"content"=>GetMessage("SORT"), "sort"=>"name",	"default"=>true),
...
while($arRes = $rsData->GetNext())
{
	...
	//$row->AddViewField("ID", "<a href=\"javascript:SetValue('".$f_ID."');\" title=\"".GetMessage("MAIN_CHANGE")."\">".$f_ID."</a>");
	$row->AddViewField("ID", "<a href=\"javascript:SelEl('".CUtil::JSEscape($arRes["ID"])."', '".CUtil::JSEscape($arRes["NAME"])."');\" title=\"".GetMessage("MAIN_CHANGE")."\">".$f_ID."</a>");	
	...
	$arActions[] = array(
		...
		"DEFAULT"=>true,
		"ACTION"=>"SelEl('".$f_ID."', '".CUtil::JSEscape($arRes["NAME"])."');"
	);
