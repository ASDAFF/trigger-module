...
if ($lAdmin->EditAction() && $CURRENCY_RIGHT=="W")
{
	foreach($FIELDS as $ID => $arFields)
	{
		...
		if (!CFTriggerEvents::Update($ID, $arFields))
		{
...
while($arRes = $rsData->NavNext(true, "f_"))
{
	...
	$arActions[] = array(
		...
		"ACTION"=>$lAdmin->ActionRedirect("/bitrix/admin/fevent_event_edit.php?ID=".$f_ID."&lang=".LANGUAGE_ID)
	);
...
$aContext = array(
	array(
		...
		"LINK"=>"/bitrix/admin/fevent_event_edit.php?lang=".LANGUAGE_ID,
